...
//
//import controller.ControllerDaVez;
//import factory.Casa;
...
//}
//
//public String verificarPosicaoJogador(int posicaoJogador){
//	ControllerDaVez controlDaVez = new ControllerDaVez();
//	Jogador jg2 = controlDaVez.nextPlayer();
//	
//	
//	for(int i = 0; i < casasEspeciais.size();i++) {
//		if(posicaoJogador == casasEspeciais.get(i).getPosicao()) {
//			jg2.setPosicao(casasEspeciais.get(i).mover());
//			
//			return "Jogador "+jg2.getNome()+" "+casasEspeciais.get(i).getDescricao()+" "+jg2.getPosicao();
//		}
//	}
//	
//	return "Jogador "+jg2.getNome()+" esta na posicao: "+jg2.getPosicao();
//	
//}
//
//
